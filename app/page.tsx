...
<header
  id="hero"
  className="relative isolate flex min-h-[100svh] overflow-hidden border-b border-white/10 bg-zinc-900 px-5 text-white sm:min-h-0 sm:px-4 sm:pb-20 sm:pt-28 lg:pt-32"
>
  ...
  <div className="container relative z-10 flex items-center sm:block">
      ...
      <div className="space-y-6 text-center sm:space-y-7 sm:text-left">
        <div className="space-y-4 sm:space-y-5">
          <div className="flex justify-center sm:justify-start">
            <span className="inline-flex items-center justify-center rounded-full border border-purple-500/35 bg-purple-500/15 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-purple-100/90 sm:tracking-[0.22em]">
          ...
          <h1 className="text-4xl font-semibold leading-[1.14] tracking-tight text-white sm:text-5xl lg:text-7xl">
            ...
            <span className="mt-3 block pb-2 bg-gradient-to-r from-purple-300 via-pink-300 to-purple-200 bg-clip-text text-transparent sm:mt-4 sm:pb-3">
              {headlineRole}
            </span>
          </h1>
        ...
        <div className="flex justify-center gap-3 pt-1 sm:justify-start">
          <Link href="https://github.com/MahmoudAbuAwd" target="_blank" rel="noopener noreferrer">
            <Button
              variant="ghost"
              size="icon"
              className="h-10 w-10 rounded-full bg-white/10 text-white/80 transition-colors duration-200 hover:bg-purple-500/20 hover:text-white"
            >
